...
In the above, a \emph{distribution} refers to a joint distribution, while \emph{point} refers to a named tuple in the space space of a given distribution.
...
\todo[inline]{Cite SimplePosets and SimpleGraphs}
