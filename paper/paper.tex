...
Finally, Soss addresses the age-old challenge of naming things in computer science via Cockney rhyming slang (``sauce pan'' rhymes with ``Stan''). {\bf S}oss is {\bf o}pen-{\bf s}ource {\bf s}oftware.
